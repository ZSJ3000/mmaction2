...
def parse_args():
    ...
    parser.add_argument(
        '--input-video',
        default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\demo\test_video_structuralize.mp4',
        type=str,
    ...
    parser.add_argument(
        '--out-filename',
        default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\data\ava\testresult\1.mp4',
        type=str,
