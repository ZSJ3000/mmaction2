...
def parse_args():
    ...
    parser.add_argument('--config',default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\configs\detection\ava\slowfast_temporal_max_focal_alpha3_gamma1_kinetics_pretrained_r50_8x8x1_cosine_10e_ava22_rgb.py', help='test config file path')
    parser.add_argument('--checkpoint',default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\slowfast_r50-k400-pre-temporal-max-focal-alpha3-gamma1_8xb6-8x8x1-cosine-10e_ava22-rgb_20220906-dd59e26f.pth', help='checkpoint file')
    parser.add_argument(
        '--out',
        default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\data\ava\testresult\test1.csv',
