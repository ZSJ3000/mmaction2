...
def parse_args():
    ...
    parser.add_argument('--config',
                        default= r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\configs\detection\ava\slowfast_kinetics_pretrained_r50_8x8x1_20e_ava_rgb.py', help='train config file path')
    parser.add_argument('--work-dir',default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\data\ava\result', help='the dir to save logs and models')
    parser.add_argument(
