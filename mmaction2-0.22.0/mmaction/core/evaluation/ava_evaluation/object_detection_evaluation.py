...
class ObjectDetectionEvaluator(DetectionEvaluator):
    ...
    def evaluate(self):
        ...
        with open(r"E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\plot\category_index_name.txt","w") as f:
            f.write(str(category_index_name))
        print("-----------------------------")
        with open(r"E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\plot\mean_ap.txt","w") as f:
            f.write(str(mean_ap))
        with open(r"E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\plot\per_class_ap.txt","w") as f:
...
class ObjectDetectionEvaluation:
    ...
    def evaluate(self):
        ...
        with open(r"E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\plot\num_gt_instances_per_class.txt","w") as f:
