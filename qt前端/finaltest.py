...
def parse_args(f_path,video_save):
    parser = argparse.ArgumentParser(
        description='MMAction2 webcam spatio-temporal detection demo')

    parser.add_argument(
        '--config',
        default=(r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\configs\detection\ava\slowfast_temporal_max_focal_alpha3_gamma1_kinetics_pretrained_r50_8x8x1_cosine_10e_ava22_rgb.py'),
        help='spatio temporal detection config file path')
    parser.add_argument(
        '--checkpoint',
        default=(r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\slowfast_r50-k400-pre-temporal-max-focal-alpha3-gamma1_8xb6-8x8x1-cosine-10e_ava22-rgb_20220906-dd59e26f.pth'),
    ...
    parser.add_argument(
        '--det-config',
        default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\mmdetection-2.20.0\configs\yolox\yolox_l_8x8_300e_coco.py',
        help='human detection config file path (from mmdet)')
    parser.add_argument(
        '--det-checkpoint',
        default=(r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\yolox_l_8x8_300e_coco_20211126_140236-d3bd2b23.pth'),
    ...
    parser.add_argument(
        '--label-map',
        default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\tools\data\ava\label_map.txt',
        help='label map file')
    parser.add_argument(
    ...
    parser.add_argument(
        '--out-filename',
        default=r'E:\桌面\研一\智能传感与检测系统\mmaction2\mmaction2-0.22.0\data\ava\testresult\{}.mp4'.format(video_save),
        type=str,
...
def main(args):
    ...
    try:
        count_clip=ClipHelper(
            ...
            show=args.show)
        count_clip.start()
        for able_to_read, task in count_clip:
            # get data from read queue
            if not able_to_read:
